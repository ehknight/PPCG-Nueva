...
So, if a game with a center board which has a 0 in the top-right corner of the center board were a <tt>currentBoard</tt>, it would look like: <tt>[[[['','',''],['','',''],['','','']],[['','',''],['','',''],['','','']],[['','',''],['','',''],['','','']]],[[['','',''],['','',''],['','','']],[['','','0'],['','',''],['','','']],[['','',''],['','',''],['','','']]],[[['','',''],['','',''],['','','']],[['','',''],['','',''],['','','']],[['','',''],['','',''],['','','']]]]</tt>. You can put that into Python or JavaScript and moneky around with that, if you like. 
</p><p>
You could access that top-right "0" element by doing <tt>currentBoard[1][1][0][2]</tt>. (In English this translates to "Give me the second row of the board, then give me the second board of that, then give me the first row of the board, then give me the third column of that".) <tt>currentBoard</tt> is a list of length 2. For example, if you were playing in the top-middle square, it <tt>board</tt> would be [0,1]. <tt>metaBoard</tt> is a 3x3 array of boards won. For example, if Player 0 has won the top left board it would look like <tt>[['0','',''],['','',''],['','','']]</tt>. Your function must return a list of length two of where you want to put your piece. For instance, if you want to go in the top right corner, your <tt>main</tt> function would return <tt>[0,2]</tt>.
</p><p>
